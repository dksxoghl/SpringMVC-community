...
<div class="container" style=" height: 150px; width: 70%">
    <div class="card" style="width: 18rem; text-align: center;margin: 0 auto; ">
        <div class="card-body">
            ...
            <button type="button" class="btn btn-primary" onclick="location.href='/${url}/delete/${seq}'">삭제</button>
            <button type="button" class="btn btn-secondary" onclick="location.href='/${url}/detail/${seq}'">취소</button>
        </div>
    </div>
